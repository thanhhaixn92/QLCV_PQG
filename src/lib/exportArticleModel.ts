...
import { Document, Packer, Paragraph, TextRun, HeadingLevel, AlignmentType, ImageRun, Table, TableRow, TableCell, BorderStyle, WidthType, type FileChild } from "docx";
...
export function exportArticleModelToDocx(blocks: ExportArticleBlock[]): FileChild[] {
