...
export function getDocumentStandardProfile(profileId?: DocumentStandardProfileId): DocumentStandardProfile {
  return DOCUMENT_STANDARD_PROFILES[profileId ?? DEFAULT_DOCUMENT_STANDARD_PROFILE_ID];
}
